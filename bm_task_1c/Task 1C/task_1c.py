...
def read_distance_sensor(client_id, sensor_handle):
	...
	##############	ADD YOUR CODE HERE	##############
	returnCode,detected,cordinates,detobjhand,surfaceNV=sim.simxReadProximitySensor(client_id,sensor_handle,
	sim.simx_opmode_streaming)
	returnCode,detected,cordinates,detobjhand,surfaceNV=sim.simxReadProximitySensor(client_id,sensor_handle,
	sim.simx_opmode_buffer)

	if detected:
		_,distance = sim.simxCheckDistance(client_id,sensor_handle,detobjhand,sim.simx_opmode_streaming)
		_,distance = sim.simxCheckDistance(client_id,sensor_handle,detobjhand,sim.simx_opmode_buffer)
	else:
		distance=-1
